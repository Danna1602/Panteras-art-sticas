...
public class Personaje1_0AnimatorController : MonoBehaviour
{
    ...
    public void EjecutarAnimacionVictoria()
    {
        ...
        {
            Debug.LogError("Faltan componentes para la animación de victoria");
            return;
        }
        ...
        _animator.speed = 1f;
        _animator.Play("VictoriaPersonaje1", 0, 0f); // Asegúrate de que el nombre coincide con el estado en el Animator
    }
